...
// ============== global variables ============== //
const endpoint =
  "https://test-c673d-default-rtdb.europe-west1.firebasedatabase.app/";
let posts;
...
function showCreatePostDialog() {
  ...
  document.querySelector("#diaCP").showModal();
}
...
async function createPost(title, body, image) {
  ...
  if (response.ok) {
    console.log("New post succefully added to Firebase");
    updatePostsGrid();
  }
